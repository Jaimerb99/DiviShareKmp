...
interface GroupRepository {
    ...
    suspend fun getMyGroups(userId: String): DiviResult<List<Group>>

    // Crea un nuevo grupo en la base de datos
    suspend fun createGroup(name: String, currency: String, inviteCode: String, creatorUserId: String): DiviResult<Group>
